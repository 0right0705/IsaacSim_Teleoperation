...
# VR_JOINT_NAMES = [
#     "wrist", # 손목 
#     "thumb-metacarpal", "thumb-phalanx-proximal", "thumb-phalanx-distal", "thumb-tip", # 엄지 손허리뼈 (손바닥과 연결된 뼈), 엄지 근위지절골 (첫 번째 마디뼈), 엄지 원위지절골 (끝 마디뼈), 엄지손가락 끝
#     "index-finger-metacarpal", "index-finger-phalanx-proximal", "index-finger-phalanx-intermediate", "index-finger-phalanx-distal", "index-finger-tip", # 검지 손허리뼈, 검지 근위지절골 (첫 번째 마디), 검지 중간지절골 (두 번째 마디), 검지 원위지절골 (세 번째/끝 마디), 검지 끝
#     "middle-finger-metacarpal", "middle-finger-phalanx-proximal", "middle-finger-phalanx-intermediate", "middle-finger-phalanx-distal", "middle-finger-tip", # 중지 손허리뼈, 중지 근위지절골 (첫 번째 마디), 중지 중간지절골 (두 번째 마디), 중지 원위지절골 (세 번째/끝 마디), 중지 끝
#     "ring-finger-metacarpal", "ring-finger-phalanx-proximal", "ring-finger-phalanx-intermediate", "ring-finger-phalanx-distal", "ring-finger-tip", # 약지 손허리뼈, 약지 근위지절골 (첫 번째 마디), 약지 중간지절골 (두 번째 마디), 약지 원위지절골 (세 번째/끝 마디), 약지 끝
#     "pinky-finger-metacarpal", "pinky-finger-phalanx-proximal", "pinky-finger-phalanx-intermediate", "pinky-finger-phalanx-distal", "pinky-finger-tip" # 새끼손허리뼈, 새끼 근위지절골 (첫 번째 마디), 새끼 중간지절골 (두 번째 마디), 새끼 원위지절골 (세 번째/끝 마디), 새끼 끝
# ] # 비전프로는 여기에 후면손목 (25), 팔 (26)이 더 있음...., 인덱스 24까진 비전프로랑 메타퀘스트에서 받아오는게 목록이랑 인덱스까지 똑같은듯!
        ...
        try:
            async for message in websocket:
                try:
                    ...
                    # 큐가 꽉 차있으면 가장 오래된 데이터를 버림 (최신성 유지 전략)
