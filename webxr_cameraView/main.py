...
class loadUSD():
    ...
    def setup_scene(self, world: World, ROBOT_PATH, ROBOT_PRIM_PATH) -> SingleArticulation:
        ...
        camera_pos = np.array([0.3, 0.0, 3.5])  # 로봇 앞 80cm, 높이 1.2m
        camera_orientation = euler_angles_to_quats(np.array([0, 90, 0]), degrees=True) # 30도 숙임
