...
ext_mgr.set_extension_enabled_immediate("isaacsim.core.api", True)
ext_mgr.set_extension_enabled_immediate("isaacsim.core.prims", True)
ext_mgr.set_extension_enabled_immediate("isaacsim.core.objects", True)
ext_mgr.set_extension_enabled_immediate("isaacsim.core.utils.numpy.rotations", True)
...
class loadUSD():
    ...
    def setup_scene(self, world: World, ROBOT_PATH, ROBOT_PRIM_PATH, STRAWBERRY_PATH, STRAWBERRY_PRIM_PATH, TABLE_PATH, TAPBLE_PRIM) -> tuple:
        ...
        self.table = RigidPrim(
            prim_paths_expr=TAPBLE_PRIM,
            name="work_table",
            positions=np.array([[0.5, 0.0, 0.0]])  # shape (1, 3)
        )
        ...
        strawberry = RigidPrim(
            prim_paths_expr=STRAWBERRY_PRIM_PATH, 
            name="strawberry_obj",
            positions=np.array([[0.6, 0.0, 0.5]]), # shape (1, 3)
            scales=np.array([[0.15, 0.15, 0.15]])  # shape (1, 3)
        )
